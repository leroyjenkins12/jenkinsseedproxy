...
## Tier 2 ASes: QTY - 8
Makers.makeTransitAs(base, 85, [2, 100], [(2, 100)], proxy[0])
...
Makers.makeTransitAs(base, 93, [12, 100], [(12, 100)], proxy[4])
...
Makers.makeTransitAs(base, 136, [100, 4], [(100, 4)], proxy[15])
...
ebgp.addRsPeers(100, [249, 85, 136, 93])
