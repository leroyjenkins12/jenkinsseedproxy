...
Makers.makeTransitAs(base, 67, [100, 61], [(100, 61)], proxy[5])
Makers.makeTransitAs(base, 68, [100, 8], [(100, 8)], proxy[6])
...
Makers.makeTransitAs(base, 133, [100, 9], [(100, 9)], proxy[71])
...
#####################################################################
Makers.makeStubAs(emu, base, 190, 100, [None], proxy[120])
...
ebgp.addRsPeers(100, [190, 67, 68, 133]) #removed 11872
...
ebgp.addRsPeers(12, [200, 102, 121, 122, 123]) #removed 100
ebgp.addRsPeers(13, [201, 98, 99, 101, 103]) #removed 100
