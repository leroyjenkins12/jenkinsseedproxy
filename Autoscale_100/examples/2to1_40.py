...
## Tier 2 ASes: QTY - 8
Makers.makeTransitAs(base, 62, [7, 100], [(7, 100)], proxy[0])
Makers.makeTransitAs(base, 63, [6, 100], [(6, 100)], proxy[1])
Makers.makeTransitAs(base, 64, [5, 100], [(5, 100)], proxy[2])
Makers.makeTransitAs(base, 65, [4, 100], [(4, 100)], proxy[3])
Makers.makeTransitAs(base, 66, [3, 100], [(3, 100)], proxy[4])
Makers.makeTransitAs(base, 67, [2, 100], [(2, 100)], proxy[5])
...
Makers.makeTransitAs(base, 110, [13, 12], [(13, 12)], proxy[25])
...
#####################################################################
Makers.makeStubAs(emu, base, 249, 100, [None], proxy[40])
...
ebgp.addRsPeers(12, [200, 110,  123, 83])
ebgp.addRsPeers(13, [201,  99, 110, 87, 80])
