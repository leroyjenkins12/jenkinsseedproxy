...
## Tier 2 ASes: QTY - 8
Makers.makeTransitAs(base, 62, [7, 100], [(7, 100)], False)
Makers.makeTransitAs(base, 63, [6, 100], [(6, 100)], False)
Makers.makeTransitAs(base, 64, [5, 100], [(5, 100)], True)
Makers.makeTransitAs(base, 65, [4, 100], [(4, 100)], False)
Makers.makeTransitAs(base, 66, [3, 100], [(3, 100)], True)
Makers.makeTransitAs(base, 67, [2, 100], [(2, 100)], True)
Makers.makeTransitAs(base, 68, [2, 8], [(2, 8)], True)
Makers.makeTransitAs(base, 69, [6, 7], [(6, 7)], True)
Makers.makeTransitAs(base, 70, [7, 2], [(7, 2)], True)
Makers.makeTransitAs(base, 71, [8, 9], [(8, 9)], True)
Makers.makeTransitAs(base, 74, [2, 10], [(2, 10)], True)
Makers.makeTransitAs(base, 80, [4, 10], [(4, 10)], False)
Makers.makeTransitAs(base, 94, [6, 5], [(6, 5)], True)
Makers.makeTransitAs(base, 112, [7, 8], [(7, 8)], True)
Makers.makeTransitAs(base, 113, [2, 3], [(2, 3)], False)
Makers.makeTransitAs(base, 124, [5, 4], [(5, 4)], True)
Makers.makeTransitAs(base, 126, [3, 4], [(3, 4)], True)
Makers.makeTransitAs(base, 127, [3, 10], [(3, 10)], True)
Makers.makeTransitAs(base, 128, [9, 10], [(9, 10)], True)
Makers.makeTransitAs(base, 133, [2, 9], [(2, 9)], True)



#Makers.makeTransitAs(base, 164, [187, 188], [(187, 188)], proxy[79])
#####################################################################
Makers.makeStubAs(emu, base, 249, 100, [None], True)
Makers.makeStubAs(emu, base, 190, 2, [None], False)
Makers.makeStubAs(emu, base, 191, 3, [None], True)
Makers.makeStubAs(emu, base, 192, 4, [None], True)
Makers.makeStubAs(emu, base, 193, 5, [None], True)
Makers.makeStubAs(emu, base, 194, 6, [None], True)
Makers.makeStubAs(emu, base, 195, 7, [None], True)
Makers.makeStubAs(emu, base, 196, 8, [None], True)
Makers.makeStubAs(emu, base, 197, 9, [None], True)
Makers.makeStubAs(emu, base, 198, 10, [None], False)
...
ebgp.addRsPeers(100, [249, 62, 63, 64, 65, 66, 67])
